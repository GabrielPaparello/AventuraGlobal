...
export const Experiencias = () => {
  ...
  return (
    <div className="bg-blue-100 pt-5">
      <h1 className={`text-4xl ${playwrite.className} text-center mt-16 mb-12`}>
        Experiencias
      </h1>
      <motion.div
          ...
          >
            <div className="relative h-80 overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center p-6">
                ...
                >
                  <h3
                    className={`${playwrite.className} text-2xl font-playwrite text-blue-300 p-2 backdrop-blur-xs mb-2`}
                  >
                    {experiencia.nombre}
                  </h3>
